	        ...
	        .bindings = {
	                suggested_binding{
	                        ...
	                        },
	                        {
	                                ...
	                                {"left_squeeze", "/user/hand/left/input/squeeze"},
	                                ...
	                                {"right_squeeze", "/user/hand/right/input/squeeze"},
	                                {"right_scroll", "/user/hand/right/input/thumbstick"},
	                                {"right_haptic", "/user/hand/right/output/haptic"},
	                                {"recenter_left", "/user/hand/left/input/squeeze"},
	                                {"recenter_right", "/user/hand/right/input/squeeze"},
